#!/usr/bin/env bash
# smoke_test.sh — Shell smoke test for lakeflow-job
#
...
if [ -z "$APP_URL" ]; then
  ...
  printf "  export APP_URL=https://lakeflow-job-dev-<workspace>.databricksapps.com\n"
  exit 1
fi
...
printf "\n${BOLD}╔══════════════════════════════════════════════════╗${NC}\n"
printf "${BOLD}║   lakeflow-job  smoke test (sh)   ║${NC}\n"
printf "${BOLD}╚══════════════════════════════════════════════════╝${NC}\n"
printf "\n  ${DIM}APP_URL:${NC} %s\n" "$APP_URL"
