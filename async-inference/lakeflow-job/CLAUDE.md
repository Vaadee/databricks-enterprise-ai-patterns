...
# Start the app
databricks bundle run lakeflow_job_app --target dev

# Get deployed app URL
databricks apps get lakeflow-job-dev
```

### Initial Setup (first time)
```bash
databricks postgres create-project --project-id lakeflow-job
databricks secrets create-scope lakeflow-job
