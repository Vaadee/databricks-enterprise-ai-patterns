#!/usr/bin/env python3
"""
smoke_test.py — End-to-end smoke test for the lakeflow-job app.
...
Usage:
    ...
    export APP_URL=https://lakeflow-job-dev-<workspace>.databricksapps.com
...
def run_tests():
    if not APP_URL:
        ...
        print("  export APP_URL=https://lakeflow-job-dev-<workspace>.databricksapps.com")
        sys.exit(1)

    token = get_token()

    print(f"\n{bold('╔══════════════════════════════════════════════════╗')}")
    print(f"{bold('║   lakeflow-job  smoke test             ║')}")
    print(f"{bold('╚══════════════════════════════════════════════════╝')}")
    print(f"\n  {dim('APP_URL:')} {APP_URL}")
