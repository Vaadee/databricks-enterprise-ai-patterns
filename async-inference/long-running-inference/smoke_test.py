#!/usr/bin/env python3
"""
smoke_test.py — End-to-end smoke test for the long-running-inference app.
...
Usage:
    ...
    export APP_URL=https://long-running-inference-dev-<workspace>.databricksapps.com
...
def run_tests():
    if not APP_URL:
        ...
        print("  export APP_URL=https://long-running-inference-dev-<workspace>.databricksapps.com")
        sys.exit(1)

    token = get_token()

    print(f"\n{bold('╔══════════════════════════════════════════════════╗')}")
    print(f"{bold('║   long-running-inference  smoke test             ║')}")
    print(f"{bold('╚══════════════════════════════════════════════════╝')}")
    print(f"\n  {dim('APP_URL:')} {APP_URL}")
